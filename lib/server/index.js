    ...
    constructor({ port }) {
        ...
        this._app.get('/', (req, res) => {
            res.render('index', {
                ...
                cover: 'https://blog.superwatermelon.com/procedural-terrain-generation/img/cover-parts-1-and-2.png',
                content: content.render('01-intro'),
                bio: content.render('bio'),
                next: 'https://blog.superwatermelon.com/procedural-terrain-generation/landmark-placement',
                canonical: 'https://blog.superwatermelon.com/procedural-terrain-generation'
            });
        });
        this._app.get('/landmark-placement', (req, res) => {
            res.render('index', {
                ...
                bio: content.render('bio'),
                prev: 'https://blog.superwatermelon.com/procedural-terrain-generation',
                canonical: 'https://blog.superwatermelon.com/procedural-terrain-generation/landmark-placement'
            });
        });
