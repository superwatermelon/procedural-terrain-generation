...
export class Server {
    constructor({ port, sslOnly, baseUrl, gaTrackingId }) {
        ...
        // Temporary while there is no blog index application to handle this
        // it exists here for the robots.txt and sitemap.xml, it is also
        // mounted under /procedural-terrain-generation
        const assets = new express.Router();
        assets.use('/', express.static(path.join(__dirname, '..', '..', 'public')));
        ...
        this._app.use('/procedural-terrain-generation', (function () {
            ...
            router.get('/', (req, res) => {
                res.render('index', {
                    ...
                    canonical: `${baseUrl}/procedural-terrain-generation/`,
                    gaTrackingId
                });
            });
            router.get('/landmark-placement', (req, res) => {
                res.render('index', {
                    ...
                    canonical: `${baseUrl}/procedural-terrain-generation/landmark-placement`,
                    gaTrackingId
                });
            });
